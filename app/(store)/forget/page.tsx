  ...
  return (
    ...
    <div className='m-auto mt-28 min-w-[100px] max-w-[424px] min-h-[50px] p-[32px] rounded-[4px] border-solid border-[1px] border-[#E4E7E9] shadow-lg drop-shadow-sm shadow-[#0000001F]'>
        ...
        <div className='m-auto mt-[30px]'>
            <p className='text-[20px] text-end text-[#191C1F]'>رقم الجوال</p>
            <input className='min-w-[150px] w-full h-[44px]  border-[1px] border-solid rounded-[2px] border-[#E4E7E9]' type="text" />
            <button className='min-w-[150px] w-full h-[48px] mt-5 text-white bg-[#FA8232] hover:bg-orange-600 transition-all duration-300 rounded-[2px] text-[20px] flex justify-center items-center'> <AiOutlineArrowLeft className="mr-2" />إرسال الرمز</button>
        </div>
        <div className="text-end my-5 text-[15px] text-[#5F6C72]">
        ...
        <hr />
        <p className="text-end text-[#475156] mt-6">يمكنك الإتصال<Link className="text-[#F58634]" href={""}> بخدمة العملاء</Link> للحصول على المساعدة في استعادة الوصول إلى حسابك</p>
    </div>

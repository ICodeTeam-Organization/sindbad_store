  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          {!product?.attributesWithValues || product?.attributesWithValues.length == 0 ? <div> <p> لاتوجد تفاصيل اخرى</p> </div> : <ProductFeaturesTable features={product?.attributesWithValues || []} />}
        </AccordionContent>
      </AccordionItem>

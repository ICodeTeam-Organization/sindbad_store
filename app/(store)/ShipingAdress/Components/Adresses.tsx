...
const Adresses = () => {
  const arr =[1,2,3,4,5];
    return (
    <div className="grid grid-cols-9 my-8 text-center items-center font-bold w-full max-w-[1800px]">
                ...
                {/* fetch api from here */}
                {arr.map((itm) => (
                    <><h1 className="text-right line-clamp-3 px-3 pt-3 col-span-2">بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج  </h1><div className="m-auto pt-3 text-gray-500 px-3 line-clamp-3 col-span-2">
                        <h1 className="text-right ">محافظة حضرموت</h1>
                        <h1 className="text-right">مديرية المكلا</h1>
                        <h1 className="text-right ">منطقة الديس</h1>
                    </div><div className="m-auto px-3 pt-3 line-clamp-3 col-span-2">
                            <h1 className="text-right  text-gray-600">محمد علي سالم عبدالله</h1>
                        </div><div className=" pt-3 col-span-2">

...
const Adresses = () => {
  const arr =[1,2,3,4,5];
    ...
    <div className="grid grid-cols-9 text-center items-center font-bold w-full text-gray-600">
                ...
                {/* fetch api from here */}
                {arr.map((itm) => (
                    <><h1 className="text-right line-clamp-3 px-3 pt-3 col-span-2 max-md:text-xs max-md:line-clamp-4">بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج بجانب مستشفى البرج  </h1>

        ...
        <CarouselContent className="">
          {Array.from({ length: 10 }).map((_, index) => (
            <CarouselItem
              ...
              <div className="max-md:w-[300px] md:w-[300px] max-md:h-[130px]  lg:w-[650px] h-[179px] max-md:mt-0 md:mt-0 mt-6">
                <h1 className="text-[25px] max-md:text-[15px] font-bold text-right">متجر نسق</h1>
                <p className="text-[17px] text-[#666666]">مستلزمات الاطفال</p>
                <div className="flex items-center max-md:mt-0 md:mt-2 mt-1">

...
function CardsInfo() {
  ...
  return (
    <div className="xlHalf:mt-52 mdHalf:mt-20 mt-10 p-4  flex items-center justify-center xl:gap-16 lg:gap-8 mdHalf:gap-5 gap-4 xl:mx-12 lg:mx-4 mdHalf:mx-4 lg:flex-nowrap flex-wrap " >
    {cards.map((item,ix)=>(

...
function EcommercesCarsoule({ allEcommrces }: PropsTypes) {
  ...
  const settings: import("react-slick").Settings = {
    dots: false,
    infinite: allEcommrces.length > 3,
    speed: 300,
    slidesToShow: 3,
    slidesToScroll: 1,
    autoplay: false,
        ...
        <div className="lg:container mx-auto relative sm:p-4 p-2">
          <div className="pt-10 mb-5 pr-3">
            <div className="flex gap-x-5 items-center justify-center">
              ...
              <h1 className="text-secondary font-bold text-xl">جميع المتاجر</h1>
              <div className="h-10 p-[1px] bg-primary rounded-full" />
            </div>
          ...
          <div className="w-full relative overflow-hidden mt-14">
            <Slider {...settings} ref={sliderRef}>
              {allEcommrces?.map((ec) => {
                return <EshopsCardCarsoul key={ec.id} {...ec} />;
              })}
            </Slider>
            <>
              <button
...
export default EcommercesCarsoule;

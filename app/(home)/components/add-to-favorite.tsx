...
const AddToFavorite = ({ id }: Props) => {
    ...
    return (
        <Button
            ...
            className={cn("cursor-pointer group hover:bg-[#F55157] hover:text-white transition-all duration-300 max-md:ml-[2px] max-md:w-[30px] max-md:h-[30px] w-[50px] h-[40px] rounded-[5px] border-[1px] flex justify-center items-center p-1",productsIds.includes(+id)&&"bg-[#F55157]")}
        >
            {
